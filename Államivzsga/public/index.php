...
if (!file_exists('../config/database.php')) {  // Ellenőrzi, hogy létezik-e az adatbázis kapcsolat fájl.
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/PROJECT.css">  <!-- A stíluslapok beillesztése a megjelenéshez. -->
</head>
<body>
<div class="wrapper">
    <header>
        <nav class="header">  <!-- A navigációs sáv a menüpontokkal és bejelentkezési információval. -->
            <div class="title">
                ...
                <div class="auth-buttons">  <!-- A bejelentkezési és regisztrációs gombok szekciója. -->
                    <?php if (!isset($_SESSION['username'])): ?>  <!-- Ha a felhasználó nincs bejelentkezve, akkor a login és regisztráció gombok jelennek meg. -->
                        <a href="../src/Views/auth/login.php"><i class="fa-solid fa-right-to-bracket"></i> Login</a>
                        <a href="../src/Views/auth/register.php"><i class="fa-solid fa-user-plus"></i> Registration</a>
                    <?php endif; ?>
                </div>
                ...
                <div class="auth-buttons">  <!-- A kijelentkezési információkat és a felhasználói üdvözlő üzenetet tartalmazó szekció. -->
                    <?php if (isset($_SESSION['username'])): ?>  <!-- Ha a felhasználó be van jelentkezve, akkor a kijelentkezés és üdvözlő üzenet jelenik meg. -->
                        <a href="../src/Views/auth/logout.php" class="auth-right"><i class="fa-solid fa-right-from-bracket"></i> Logout</a>
                ...
                <div class="header-actions">  <!-- Kosár és rendelések gombjai a bejelentkezett felhasználóknak. -->
                    <?php if (isset($_SESSION['username'])): ?>  <!-- Ha a felhasználó be van jelentkezve, akkor láthatja a kosár és rendelés linkeket. -->
                        <a id="cart-icon" href="../src/Views/cart/my_cart.php" class="header-link">
                            <i class="fa-solid fa-basket-shopping"></i> My Cart
                        </a>
                        <a id="orders-icon" href="../src/Views/orders/my_orders.php" class="header-link">
            ...
            <div class="menu">  <!-- A menüpontok, amelyek különböző termékkategóriákra vezetnek. -->
                <a href="../src/Views/products/tracksuits.php">Club Apparel</a>
                <a href="../src/Views/products/jerseys.php">Club Jerseys</a>
                <a href="../src/Views/products/shoes.php">Football Shoes</a>
                <a href="../src/Views/products/balls.php">Football Balls</a>
            </div>
        </nav>
    </header>
    <main>
        <?php foreach ($products as $product): ?>  <!-- A termékek megjelenítése. Minden egyes termékről képet, nevet és árat jelenít meg. -->
            <a href="../src/Views/products/product_detail.php?product_id=<?= $product->id ?>" class="product">
                <div>
