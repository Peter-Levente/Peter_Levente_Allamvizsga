...
<head>
    ...
    <link rel="stylesheet" href="../../../public/assets/css/PROJECT.css"> <!-- Stíluslap beillesztése -->
            ...
            <div class="title">
                ...
                <div class="auth-buttons">
                    ...
                    <?php if (!isset($_SESSION['username'])): ?>
                        ...
                        <a href="../auth/login.php"><i class="fa-solid fa-right-to-bracket"></i> Login</a> <!-- Bejelentkezés -->
                        <a href="../auth/register.php"><i class="fa-solid fa-user-plus"></i> Registration</a> <!-- Regisztráció -->
                    <?php endif; ?>
                </div>
                ...
                <div class="auth-buttons">
                    ...
                    <?php if (isset($_SESSION['username'])): ?>
                        ...
                        <a href="../auth/logout.php" class="auth-right"><i class="fa-solid fa-right-from-bracket"></i> Logout</a> <!-- Kijelentkezés -->
                    <?php endif; ?>
                </div>
                ...
                <div class="header-actions">
                    ...
                    <?php if (isset($_SESSION['username'])): ?>
                        <a id="cart-icon" href="../cart/my_cart.php" class="header-link">
                            <i class="fa-solid fa-basket-shopping"></i> My Cart <!-- Kosár -->
                        </a>
                        <a id="orders-icon" href="../orders/my_orders.php" class="header-link">
