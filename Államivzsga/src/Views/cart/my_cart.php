...
<head>
    ...
    <title>My Cart</title>
    <link rel="stylesheet" href="../../../public/assets/css/cart.css"> <!-- A kosár stíluslapja -->
</head>
<body>
<div class="container">
    <header>
        <nav class="navbar">
            ...
            <div>
                <a href="../../../public/index.php">Home</a> <!-- Link a főoldalra -->
            </div>
        </nav>
    </header>
    ...
    <main class="cart-page">
        ...
        <?php if (!empty($cartItems)): ?> <!-- Ha a kosár nem üres -->
                ...
                <?php foreach ($cartItems as $item): ?> <!-- Végig iterálunk a kosár elemein -->
                    <tr>
                        ...
                        <td class="item-quantity">
                            <form method="post" action="../../../Cart%20management/update_cart.php">
                                <input
                                        type="hidden"
                                        name="cart_id"
                        ...
                        <td>
                            <form method="post" action="../../../Cart%20management/remove_from_cart.php">
            ...
            <div class="cart-buttons">
                <button onclick="location.href='checkout.php'">Checkout</button> <!-- Fizetés gomb -->
                <button onclick="location.href='../../../public/index.php'">Continue Shopping</button> <!-- Vásárlás folytatása -->
            </div>
        <?php else: ?>
